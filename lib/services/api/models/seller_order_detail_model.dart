class SellerOrderDetailModel {
  int? status;
  SellerOrderDetailData? sellerOrderDetailData;

  SellerOrderDetailModel({this.status, this.sellerOrderDetailData});

  SellerOrderDetailModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    sellerOrderDetailData = json['data'] != null ? SellerOrderDetailData.fromJson(json['data']) : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (sellerOrderDetailData != null) {
      data['data'] = sellerOrderDetailData!.toJson();
    }
    return data;
  }
}
...
class SellerOrderDetailData {
  ...
  SellerOrderDetailData.fromJson(Map<String, dynamic> json) {
    sId = json['_id'];
