class DetailProductModel {
  ...
  DetailProductModel({this.status, this.detailProductData});

  DetailProductModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    detailProductData = json['data'] != null ? DetailProductData.fromJson(json['data']) : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (detailProductData != null) {
      data['data'] = detailProductData!.toJson();
    }
    return data;
  }
}
